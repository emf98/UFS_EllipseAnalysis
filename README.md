...
* `MBE_SSW_Test.ipynb` and `MBE_SSW_Temps.ipynb` provide an example analysis of viewing timeseries averages of temperatures and ellipse values in the dates surrounding forecasts containing SSWs at a near-subseasonal lead vs. Normal forecasts.

* `MBE_TestwSig.ipynb` provides an example visualization of box and whisker/bar plots produced with UFS and ERA-5 data.  
